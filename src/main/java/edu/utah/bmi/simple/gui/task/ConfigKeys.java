...
public class ConfigKeys {
    public static final String importDir = "from/corpusDir";

    public static final String importFilters = "from/fileFilter";

    public static final String ehostProjectDir = "ehost/projectDir";
    public static final String ehostAnnotatorName = "ehost/overWriteAnnotatorName";
    ...
    public static final String annotatorCompare = "compare/sourceAnnotator";
    public static final String annotatorAgainst = "compare/referenceAnnotator";
