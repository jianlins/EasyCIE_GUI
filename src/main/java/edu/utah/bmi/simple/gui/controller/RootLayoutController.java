...
public class RootLayoutController {
    ...
    private void about() {
        ...
        alert.setContentText("Easy Clinical Information Extractor (version 3.0.2-SNAPSHOT)\n" +
                "By Jianlin Shi," +
                "University of Utah School of Medicine,\n" +
                "Biomedical Informatics");


        double centerXPosition = mainApp.getPrimaryStage().getX() + mainApp.getPrimaryStage().getWidth() / 2d;
        double centerYPosition = mainApp.getPrimaryStage().getY() + mainApp.getPrimaryStage().getHeight() / 2d;


        ImageView logo = new ImageView("edu/utah/bmi/simple/gui/view/transbig.png");
        ...
        alert.getDialogPane().getExpandableContent().setManaged(true);
...
//        service.start();
    ...
    private String getText() {
        String aboutText = "                                 Apache License\n" +
