...
//  }
    ...
    public Feature addFeature(String featureName, Type domainType, Type rangeType,
        ...
        if(featureName.trim().length()==0)
            System.err.println(featureNameST+"\t"+domainType+"\t"+rangeType);
...
//  }
    ...
    /**
     * @see TypeSystemMgr#setFeatureFinal(Type)
     */
    @Override
    ...
    /**
     * @see TypeSystemMgr#setInheritanceFinal(Type)
     */
    @Override
    ...
    /**
     * @see TypeSystemMgr#addStringSubtype
     */
    @Override
