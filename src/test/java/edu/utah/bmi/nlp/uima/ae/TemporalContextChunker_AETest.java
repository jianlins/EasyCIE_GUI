...
class TemporalContextChunker_AETest extends TemporalContext_AE_Test {
    ...
    void test2() throws ResourceInitializationException, AnalysisEngineProcessException {
        String inputText = "HPI: \n" +
                "He is a 43 year old who presents with infection. " +
                "He is s/p infection on 1/1/15 and 1/5/2015 with infection placement, " +
                "s/p infection of penis on 1/9/2015. Then he got another infection at home.";
        String recordDate = "01/12/2015", referenceDate = "01/01/2015";
    ...
    @Test
    void test3FastNERVersion() throws ResourceInitializationException, AnalysisEngineProcessException {
        String inputText = "Record Date 1/27/2015\n" +
                "HPI:\n" +
                "Soft tissue infection 1/10/2015. Developed abdomen infection later. On 1/19/2015, the pt went to urgent care. The infection exacerbated. " +
                "The patient visited the ED on 1/22. And then he was admitted to the S Hospital for infection treatement.\n";
        ...
        String nerRule = "@fastner\n" +
                "@CONCEPT_FEATURES\tINFECTION\tConcept\n" +
                "infection\tINFECTION";
        String tempRuleStr = "src/test/resources/edu.utah.bmi.nlp.uima.ae/51_TemporalAnnotator_AE.tsv";
        String tempContextRuleStr = "src/test/resources/edu.utah.bmi.nlp.uima.ae/60_TemporalContextAnnotator_AE.tsv";
